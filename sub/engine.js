...
module.exports = /******/ (function(modules) {
  ...
  /******/ [
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var _components_elements_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        1
      );
      /* harmony import */ var _common_pool_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        4
      );
      /* harmony import */ var tiny_emitter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        3
      );
      /* harmony import */ var tiny_emitter__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/ __webpack_require__.n(
        tiny_emitter__WEBPACK_IMPORTED_MODULE_2__
      );
      /* harmony import */ var css_layout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        5
      );
      /* harmony import */ var css_layout__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(
        css_layout__WEBPACK_IMPORTED_MODULE_3__
      );
      /* harmony import */ var _common_util_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
        6
      );
      /* harmony import */ var _libs_fast_xml_parser_parser_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
        7
      );
      /* harmony import */ var _libs_fast_xml_parser_parser_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/ __webpack_require__.n(
        _libs_fast_xml_parser_parser_js__WEBPACK_IMPORTED_MODULE_5__
      );
      /* harmony import */ var _common_bitMapFont__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
        13
      );
      /* harmony import */ var _components_index_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
        15
      );
      ...
      var imgPool = new _common_pool_js__WEBPACK_IMPORTED_MODULE_1__["default"](
        "imgPool"
      );
      var canvasPool = new _common_pool_js__WEBPACK_IMPORTED_MODULE_1__[
        "default"
      ]("canvasPool");
      var constructorMap = {
        ...
        scrollview:
          _components_index_js__WEBPACK_IMPORTED_MODULE_7__["ScrollView"],
        bitmapText:
          _components_index_js__WEBPACK_IMPORTED_MODULE_7__["BitMapText"]
      };
      ...
      function layoutChildren(dataArray, children) {
        ...
        dataArray.forEach(function(data) {
          ...
          if (child.parent) {
            child.layoutBox.absoluteX =
              (child.parent.layoutBox.absoluteX || 0) + child.layoutBox.left;
            child.layoutBox.absoluteY =
              (child.parent.layoutBox.absoluteY || 0) + child.layoutBox.top;
          } else {
      ...
      var updateRealLayout = function updateRealLayout(
        dataArray,
        children,
        scale
      ) {
        dataArray.forEach(function(data) {
          ...
          if (child.parent) {
            child.realLayoutBox.realX =
              (child.parent.realLayoutBox.realX || 0) +
              child.realLayoutBox.left;
            Object.defineProperty(child.realLayoutBox, "realY", {
              configurable: true,
              enumerable: true,
              get: function get() {
                var res =
                  (child.parent.realLayoutBox.realY || 0) +
                  child.realLayoutBox.top;
                /**
                 * 滚动列表事件处理
                 */
      ...
      var _Layout = /*#__PURE__*/ (function(_Element) {
        ...
        function _Layout() {
          ...
          _this3.renderport = {};
          _this3.viewport = {};
          _this3.touchStart = _this3
            .eventHandler("touchstart")
            .bind(_assertThisInitialized(_this3));
          _this3.touchMove = _this3
            .eventHandler("touchmove")
            .bind(_assertThisInitialized(_this3));
          _this3.touchEnd = _this3
            .eventHandler("touchend")
            .bind(_assertThisInitialized(_this3));
          _this3.touchCancel = _this3
            .eventHandler("touchcancel")
            .bind(_assertThisInitialized(_this3));
          ...
          _this3.state =
            _common_util_js__WEBPACK_IMPORTED_MODULE_4__["STATE"].UNINIT;
          _this3.bitMapFonts = [];
          return _this3;
        }
        /**
        ...
        _createClass(_Layout, [
          ...
          },
          {
            ...
            value: function init(template, style, attrValueProcessor) {
              ...
              if (
                attrValueProcessor &&
                typeof attrValueProcessor === "function"
              ) {
                parseConfig.attrValueProcessor = attrValueProcessor;
              }

              var jsonObj = _libs_fast_xml_parser_parser_js__WEBPACK_IMPORTED_MODULE_5___default.a.parse(
                template,
                parseConfig,
                true
              );
              ...
              if (
                rootEle.style.width === undefined ||
                rootEle.style.height === undefined
              ) {
                console.error(
                  "Please set width and height property for root element"
                );
              } else {
              ...
              this.state =
                _common_util_js__WEBPACK_IMPORTED_MODULE_4__["STATE"].INITED;
            }
          },
          {
            key: "layout",
            value: function layout(context) {
              ...
              if (this.renderContext) {
                this.renderContext.clearRect(
                  0,
                  0,
                  this.renderport.width,
                  this.renderport.height
                );
              }

              if (!this.hasViewPortSet) {
                console.error(
                  "Please invoke method `updateViewPort` before method `layout`"
                );
              }

              layoutChildren.call(
                this,
                this.elementTree.children,
                this.children
              );
              ...
              this.bindEvents();
              this.state =
                _common_util_js__WEBPACK_IMPORTED_MODULE_4__["STATE"].RENDERED;
            }
          },
          {
            key: "getChildByPos",
            value: function getChildByPos(tree, x, y) {
              ...
              for (var i = 0; i < list.length; i++) {
                ...
                if (
                  box.realX <= x &&
                  x <= box.realX + box.width &&
                  box.realY <= y &&
                  y <= box.realY + box.height
                ) {
                  if (Object.keys(child.children).length) {
          ...
          },
          {
            ...
            value: function eventHandler(eventName) {
              return function touchEventHandler(e) {
                ...
                var item =
                  touch && this.getChildByPos(this, touch.pageX, touch.pageY);
                ...
                if (
                  eventName === "touchend" &&
                  Object(
                    _common_util_js__WEBPACK_IMPORTED_MODULE_4__["isClick"]
                  )(this.touchMsg)
                ) {
          ...
          },
          {
            ...
            value: function bindEvents() {
              ...
              if (typeof wx !== "undefined") {
                qq.onTouchStart(this.touchStart);
                qq.onTouchMove(this.touchMove);
                qq.onTouchEnd(this.touchEnd);
                qq.onTouchCancel(this.touchCancel);
              } else {
          ...
          },
          {
            ...
            value: function clear() {
              ...
              this.layoutTree = {};
              this.state =
                _common_util_js__WEBPACK_IMPORTED_MODULE_4__["STATE"].CLEAR;
          ...
          },
          {
            ...
            value: function loadImgs(arr) {
              arr.forEach(function(src) {
                var img = Object(
                  _common_util_js__WEBPACK_IMPORTED_MODULE_4__["createImage"]
                )();
                imgPool.set(src, img);
          ...
          },
          {
            ...
            value: function registBitMapFont(name, src, config) {
              var font = new _common_bitMapFont__WEBPACK_IMPORTED_MODULE_6__[
                "default"
              ](name, src, config);
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var _style_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        2
      );
      function _classCallCheck(instance, Constructor) {
        if (!(instance instanceof Constructor)) {
      ...
      var Element = /*#__PURE__*/ (function() {
        function Element(_ref) {
          ...
          for (var key in this.style) {
            if (
              _style_js__WEBPACK_IMPORTED_MODULE_0__["scalableStyles"].indexOf(
                key
              ) > -1
            ) {
              this.style[key] *= dpr;
            ...
            value: function emit(event) {
              for (
                var _len = arguments.length,
                  theArgs = new Array(_len > 1 ? _len - 1 : 0),
                  _key = 1;
                _key < _len;
                _key++
              ) {
    ...
    /***/ function(module, exports, __webpack_require__) {
      var __WEBPACK_AMD_DEFINE_FACTORY__,
        ...
        __WEBPACK_AMD_DEFINE_RESULT__; // UMD (Universal Module Definition)
      ...
      (function(root, factory) {
        ...
        var computeLayout = (function() {
          ...
          function isDimDefined(node, axis) {
            return (
              node.style[dim[axis]] !== undefined && node.style[dim[axis]] >= 0
            );
          }
          ...
          function layoutNodeImpl(
            ...
            var /*css_direction_t*/ direction = resolveDirection(
                node,
                parentDirection
              );
            ...
            if (isMeasureDefined(node)) {
              ...
              var /*bool*/ isRowUndefined =
                  !isDimDefined(node, resolvedRowAxis) &&
            ...
            var /*bool*/ isMainDimDefined = !isUndefined(
                node.layout[dim[mainAxis]]
              );
            var /*bool*/ isCrossDimDefined = !isUndefined(
            ...
            if (isMainDimDefined) {
              definedMainDim =
                node.layout[dim[mainAxis]] - paddingAndBorderAxisMain;
            }
            ...
            while (endLine < childCount) {
              ...
              if (flexibleChildrenCount !== 0) {
                var /*float*/ flexibleMainDim =
                    remainingMainDim / totalFlexible;
              ...
              for (i = firstComplexMain; i < endLine; ++i) {
                ...
                if (
                  ...
                  if (getPositionType(child) === CSS_POSITION_RELATIVE) {
                    ...
                    // the spacing.
                    mainDim +=
                      betweenMainDim + getDimWithMargin(child, mainAxis);
            ...
            if (linesCount > 1 && isCrossDimDefined) {
              ...
              for (i = 0; i < linesCount; ++i) {
                ...
                for (ii = startIndex; ii < endIndex; ++ii) {
                  ...
                  var /*css_align_t*/ alignContentAlignItem = getAlignItem(
                      node,
                      child
                    );
            ...
            if (!isCrossDimDefined) {
              node.layout[dim[crossAxis]] = fmaxf(
                ...
                boundAxis(
                  node,
                  crossAxis,
                  linesCrossDim + paddingAndBorderAxisCross
                ),
                paddingAndBorderAxisCross
              );
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      function getDpr() {
        /* istanbul ignore if*/
        if (typeof wx !== "undefined") {
          return qq.getSystemInfoSync().devicePixelRatio;
        } else {
  ...
  return Object.assign(b,a);
          ...
          if (tagType === TagType.CLOSING) {
            ...
            if (currentNode.parent && tag[14]) {
              currentNode.parent.val =
                ...
                "" +
                processTagValue(tag, options, currentNode.parent.tagname);
            }
          ...
          for (var i = 0; i < len; i++) {
            ...
            if (attrName.length) {
              if (matches[i][4] !== undefined) {
                ...
                matches[i][4] = options.attrValueProcessor(
                  matches[i][4],
                  attrName
                );
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var _imageManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        14
      );
      /* harmony import */ var _pool__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        4
      );
      function _classCallCheck(instance, Constructor) {
        if (!(instance instanceof Constructor)) {
      ...
      var bitMapPool = new _pool__WEBPACK_IMPORTED_MODULE_2__["default"](
        "bitMapPool"
      );
      ...
      var BitMapFont = /*#__PURE__*/ (function() {
        function BitMapFont(name, src, config) {
          ...
          this.texture = _imageManager__WEBPACK_IMPORTED_MODULE_1__[
            "default"
        ...
        _createClass(BitMapFont, [
            ...
            value: function parseConfig(fntText) {
              ...
              for (var i = 4; i < 4 + charsCount; i++) {
                ...
                var letter = String.fromCharCode(
                  this.getConfigByKey(charText, "id")
                );
                var c = {};
                chars[letter] = c;
          ...
          },
          {
            ...
            value: function getConfigByKey(configText, key) {
              ...
              for (
                var i = 0, length = itemConfigTextList.length;
                i < length;
                i++
              ) {
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      __webpack_require__.r(__webpack_exports__);
      /* harmony import */ var _pool__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        4
      );
      ...
      var imgPool = new _pool__WEBPACK_IMPORTED_MODULE_0__["default"](
        "imgPool"
      );
          ...
          },
          {
            ...
            value: function loadImage(src) {
              var callback =
                arguments.length > 1 && arguments[1] !== undefined
                  ? arguments[1]
                  : _util__WEBPACK_IMPORTED_MODULE_1__["none"];
              var img = null;
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      __webpack_require__.r(__webpack_exports__);
      /* harmony import */ var _view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        16
      );
      ...
      /* harmony import */ var _image_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        17
      );
      /* harmony reexport (safe) */ __webpack_require__.d(
        __webpack_exports__,
      ...
      /* harmony import */ var _text_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        18
      );
      /* harmony reexport (safe) */ __webpack_require__.d(
        __webpack_exports__,
      ...
      /* harmony import */ var _scrollview_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        19
      );
      /* harmony reexport (safe) */ __webpack_require__.d(
        __webpack_exports__,
      ...
      /* harmony import */ var _bitmapText_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
        21
      );
      /* harmony reexport (safe) */ __webpack_require__.d(
        __webpack_exports__,
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var _elements_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        1
      );
      function _typeof(obj) {
        "@babel/helpers - typeof";
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var _common_util_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        6
      );
      /* harmony import */ var _common_pool_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        4
      );
      function _typeof(obj) {
        "@babel/helpers - typeof";
      ...
      var imgPool = new _common_pool_js__WEBPACK_IMPORTED_MODULE_2__["default"](
        "imgPool"
      );
          ...
          },
          {
            ...
            value: function initImg() {
              ...
              var callback =
                arguments.length > 0 && arguments[0] !== undefined
                  ? arguments[0]
                  : _common_util_js__WEBPACK_IMPORTED_MODULE_1__["none"];
              this.img = null;
              ...
              if (cache && cache.loadDone) {
                ...
                this.img = Object(
                  _common_util_js__WEBPACK_IMPORTED_MODULE_1__["createImage"]
                )();
                this.img.onloadcbks = [];
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      var getContext = function getContext() {
        ...
        var canvas = Object(
          _common_util_js__WEBPACK_IMPORTED_MODULE_1__["createCanvas"]
        )();
        canvas.width = 1;
        canvas.height = 1;
      ...
      function getTextWidth(style, value) {
        ...
        context.font = ""
          .concat(style.fontWeight || "normal", " ")
          .concat(style.fontSize || 12, "px ")
          .concat(style.fontFamily || DEFAULT_FONT_FAMILY);
        ...
        _createClass(Text, [
          {
            ...
            value: function toCanvasData() {
              ...
              this.font = ""
                .concat(style.fontWeight || "", " ")
                .concat(style.fontSize || 12, "px ")
                .concat(DEFAULT_FONT_FAMILY);
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var _common_touch_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        20
      );
      /* harmony import */ var _common_util_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        6
      );
      function _typeof(obj) {
        "@babel/helpers - typeof";
      ...
      var ScrollView = /*#__PURE__*/ (function(_View) {
        ...
        function ScrollView(_ref) {
          ...
          _this.touch = new _common_touch_js__WEBPACK_IMPORTED_MODULE_2__[
            "default"
          ...
          _this.throttleRepaint = Object(
            _common_util_js__WEBPACK_IMPORTED_MODULE_3__["throttle"]
          )(_this.clipRepaint, 16, _assertThisInitialized(_this));
          _this.renderTimers = [];
          return _this;
        }
        /**
        ...
        _createClass(ScrollView, [
          ...
          },
          {
            ...
            value: function calPageData() {
              this.pageCount = Math.ceil(
                (this.scrollHeight + this.layoutBox.absoluteY) / this.pageHeight
              );
          ...
          },
          {
            ...
            value: function clipRepaint(top) {
              ...
              if (
                this.isDestroyed ||
                this.root.state ===
                  _common_util_js__WEBPACK_IMPORTED_MODULE_3__["STATE"].CLEAR
              ) {
                return;
              } // 在主canvas上面将滚动列表区域擦除
          ...
          },
          {
            ...
            value: function insertElements(pageIndex) {
              ...
              var can = Object(
                _common_util_js__WEBPACK_IMPORTED_MODULE_3__["createCanvas"]
              )();
          ...
          },
          {
            ...
            value: function touchEndHandler() {
              ...
              if (timeInS < 0.9) {
                ...
                this.target +=
                  ((this.target - this.move) * 0.6) / (timeInS * 5);
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var css_layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        5
      );
      /* harmony import */ var css_layout__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(
        css_layout__WEBPACK_IMPORTED_MODULE_1__
      );
      /* harmony import */ var _common_bitMapFont__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        13
      );
      /* harmony import */ var _common_pool_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        4
      );
      function _typeof(obj) {
        "@babel/helpers - typeof";
      ...
      var bitMapPool = new _common_pool_js__WEBPACK_IMPORTED_MODULE_3__[
        "default"
      ]("bitMapPool");
      ...
      var BitMapText = /*#__PURE__*/ (function(_Element) {
        ...
        function BitMapText(opts) {
          ...
          if (!_this.font) {
            console.error(
              "Please invoke API `registBitMapFont` before using `BitMapText`"
            );
          }
          ...
          },
          {
            ...
            value: function getTextBounds() {
              ...
              var _style$letterSpacing = style.letterSpacing,
                letterSpacing =
                  _style$letterSpacing === void 0 ? 0 : _style$letterSpacing;
              var width = 0;
              var offsetX = 0;
              var offsetY = 0;
