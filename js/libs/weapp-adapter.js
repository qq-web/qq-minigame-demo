...
/***/ (function(module, exports) {
	...
	var _qq$getSystemInfoSync = qq.getSystemInfoSync(),
	    screenWidth = _qq$getSystemInfoSync.screenWidth,
	    screenHeight = _qq$getSystemInfoSync.screenHeight,
	    devicePixelRatio = _qq$getSystemInfoSync.devicePixelRatio
...
/***/ (function(module, exports) {
	...
	var localStorage = {
	  get length() {
	    var _qq$getStorageInfoSyn = qq.getStorageInfoSync(),
	        keys = _qq$getStorageInfoSyn.keys

	    return keys.length
	  },

	  key: function key(n) {
	    var _qq$getStorageInfoSyn2 = qq.getStorageInfoSync(),
	        keys = _qq$getStorageInfoSyn2.keys
